<html lang="en">
    <head>
        ...
        <title>Edit Highlight Kegiatan</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="{{ route('highlight.update', $kegiatan -> id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="event_id" id="event_id">
                                                ...
                                                <option value="{{$kegiatan->event_id }}">{{$kegiatan->event->title }}</option>
                                                @foreach ($agenda as $a)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="event_id" id="event_id">
                                                ...
                                                <option value="{{$kegiatan->event_id }}">{{$kegiatan->event->start }}</option>
                                                @foreach ($agenda as $a)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="keterangan" id="keterangan" class="form-control">{{ $kegiatan->keterangan}}</textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <img width="150px" src="{{ url('/images/kegiatan/'. $kegiatan -> foto) }}">
                                        </div>
                                    <!-- /.card-body -->
