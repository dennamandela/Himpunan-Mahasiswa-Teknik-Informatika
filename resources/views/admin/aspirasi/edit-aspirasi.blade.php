                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="{{ url('/admin/aspirasi/update',$aspirasi->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="judul">Tujuan Aspirasi</label>
                                            <input type="text" class="form-control" id="tujuan_aspirasi" name="tujuan_aspirasi" value="{{$aspirasi->tujuan_aspirasi}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="isi">Isi Aspirasi</label>
                                            <textarea class="form-control" rows="3" id="isi_aspirasi" name="isi_aspirasi">{{ $aspirasi->isi_aspirasi}}</textarea>
                                        </div>
