                                ...
                                <form action="{{ url('/admin/galeri/update', $galeri->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_kegiatan" name="nama_kegiatan" value="{{$galeri->nama_kegiatan}}" placeholder="Nama Kegiatan">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Link Drive</label>
                                            <input type="url" class="form-control" id="link_drive" name="link_drive" value="{{$galeri->link_drive}}" placeholder="Link Drive">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <img width="150px" src="{{ url('/images/galeri/'. $galeri -> image) }}">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
