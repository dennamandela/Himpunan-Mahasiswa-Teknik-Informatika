                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="{{ url('/writer/berita/store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="headline" name="headline" placeholder="Masukkan Headline Berita">
                                        </div>
                                        <div class="form-group">
                                            <label for="isi">Isi Berita</label>
                                            <textarea class="form-control" rows="3" id="isi_berita" name="isi_berita" placeholder="Masukkan Isi Berita"></textarea>
                                        </div>
                                        <div class="form-group">
